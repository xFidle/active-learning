...
\begin{table}[!ht]
	\begin{minipage}{0.48\linewidth}
		...
		\begin{tabular}{lcccc}
			...
			\textit{SKLEARN-svm} & 0.740   & 0.008 & 0.754 & 0.728 \\
			\bottomrule
		\end{tabular}
		\caption{Porównanie miary \textbf{accuracy} dla SVM.}
	\end{minipage}
	\hfill
	\begin{minipage}{0.48\linewidth}
		\centering
		...
		\begin{tabular}{lcccc}
			...
			\textit{SKLEARN-svm} & 0.805   & 0.006 & 0.815 & 0.794 \\
			\bottomrule
		\end{tabular}
		\caption{Porównanie miary \textbf{F1-Score} dla SVM.}
	\end{minipage}
\end{table}
...
\begin{table}[!ht]
	\begin{minipage}{0.48\linewidth}
		...
		\begin{tabular}{lcccc}
			...
			\textit{SKLEARN-svm} & 0.846   & 0.009 & 0.856 & 0.826 \\
			\bottomrule
		\end{tabular}
		\caption{Porównanie miary \textbf{recall} dla SVM.}
	\end{minipage}
	\hfill
	\begin{minipage}{0.48\linewidth}
		\centering
		...
		\begin{tabular}{lcccc}
			...
			\textit{SKLEARN-svm} & 0.767   & 0.006 & 0.780 & 0.759 \\
			\bottomrule
		\end{tabular}
		\caption{Porównanie miary \textbf{precision} dla SVM.}
	\end{minipage}
\end{table}
