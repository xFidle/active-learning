...
Na początku uczenia aktywnego wybierany jest początkowy zestaw przykładów.
Wariant \textit{random} zakłada losowy dobór próbek, natomiast inicjalizacja
\textit{cluster} stara się rozłożyć wybór na różne obszary przestrzeni cech,
aby zbiór startowy był bardziej reprezentatywny. Dzięki temu model szybciej
uzyskuje podstawową wiedzę o strukturze danych i klasach.
